...
export default function Home() {
  useEffect(() => {
    ...
    tl.fromTo(
      ".svg-img",
      {
        ...
        filter: "drop-shadow( 0px 0px 190px rgba(100, 100, 255, 1))",
      },
      {
        transform: 1,
        stroke: "rgb(100, 100, 200)",
        strokeDashoffset: "0",
        filter: "drop-shadow( 0px 0px 6px rgba(100, 100, 255, .7))",
        duration: 2.2,
        delay: 0.1,
        ease: "ease.inOut",
      }
  ...
  return (
    <div className="container mx-auto px-5 thiss">
      <div className="flex flex-col justify-center items-center gap-28 md:h-screen overflow-hidden">
        {/* header start */}
        ...
        <div className="max-w-[1024px] my-[200px] md:mt-0 grid grid-cols-4 md:grid-cols-8 gap-6">
          <div className="col-span-4 md:col-span-4 row-span-2 text-center text-lg flex items-center bg-blue-50 rounded-[35px] p-6 card text-blue-900">
            <p>
          ...
          <div className="col-span-4 md:col-span-2 flex justify-center items-center bg-blue-50 rounded-[35px] card">
            <a
          ...
          <div className="col-span-1 md:col-span-1 flex justify-center items-center bg-blue-50 rounded-[35px] card">
            <a
              href="https://www.linkedin.com/in/kartikey-soni-a0b527220/"
              target="_blank"
              rel="noreferrer"
              className="w-full h-full p-2 md:p-5 flex items-center justify-center"
            >
              <img
          ...
          <div className="col-span-1 md:col-span-1 flex justify-center items-center bg-blue-50 rounded-[35px] card">
            <a
              ...
              className="w-full h-full p-2 md:p-5 flex items-center justify-center"
            >
              <img src="/images/insta-logo.png" alt="ArtStation" className="" />
            </a>
          </div>
          ...
          <div className="col-span-1 md:col-span-1 flex justify-center items-center bg-blue-50 rounded-[35px] card">
            <a
              ...
              className="w-full h-full p-2 md:p-5 flex items-center justify-center"
            >
              <img src="/images/x-logo.png" alt="ArtStation" className="" />
            </a>
          </div>
        </div>
      </div>
