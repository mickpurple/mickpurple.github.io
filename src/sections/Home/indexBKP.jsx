...
export default function HomeOld() {
  ...
  const SocialIcon = ({ link, image }) => {
    return (
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="h-16 w-16 flex items-center justify-center duration-300 transition-all bg-[#312d56] hover:bg-[#EBEBEB] rounded-[30%] hover:rounded-[100%] hover:scale-110"
      >
  ...
  const SimpleCard = ({ link, image }) => {
    return (
      <div
        className={`flex justify-center items-center bg-[#c6c4c4] rounded-[25px] hover:rounded-[40px] transition-[border-radius] duration-300 card`}
      >
        <a
          href={link}
          target="_blank"
    ...
    <>
      ...
      <div className="container mx-auto px-5">
        <div className="relative flex flex-col justify-center items-center gap-20 md:h-screen overflow-hidden">
          ...
          <div className="max-w-[900px]X mt-[200px] md:mt-0">
            {/* socials */}
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="text-start text-2xl xl:text-4xl flex items-center bg-[#cdc5a8] rounded-[25px] transition-[border-radius] duration-300 p-6 md:p-9 card md:max-w-[300px] md:max-h-[300px]">
                <p>
                  Software developer and tech enthusiast with a thing for art
                  and design.
                </p>
              </div>
              ...
              <div className="flex justify-center items-center bg-[#cdc5a8] rounded-[25px] hover:rounded-[40px] transition-[border-radius] duration-300 card">
                <a
                  href="/#projects"
                  rel="noreferrer"
                ...
                >
                  ...
                  <p className="text-center text-lg xl:text-4xl px-5">
                    projects
                  </p>
                </a>
              </div>
